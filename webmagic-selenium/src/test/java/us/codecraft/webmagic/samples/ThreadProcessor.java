...
//    private static String[] strings = {"苹果","栗子","香蕉","橘子","西瓜","桃子","tomato"};
    private static String[] strings = {"苹果","栗子","香蕉","橘子","西瓜","恶心","脓","疮","尸体","血腥","密集恐惧","生吞","寄生虫","面包虫","蛇","色情","低俗.","性感","丝袜","情趣","诱惑","裸照","性挑逗","床照","胸","摸胸","乳房","臀","强奸","性侵","迷奸"};
...
//                WebDriver driver = new PhantomJSDriver();
                ...
                driver.findElement(By.id("lst-ib")).sendKeys(strings[i]);//找到kw元素的id，然后输入需要搜索的值
...
//                ((JavascriptExecutor)driver).executeScript("arguments[0].scrollIntoView(false)", webElements.get(webElements.size() - 1));
        ...
        public  void downLoadFromUrl (String urlStr, int i){
            String filePath = "D:\\工作\\googleimage\\"+ strings[i] +"\\";
